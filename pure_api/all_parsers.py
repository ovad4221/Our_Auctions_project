...
parser_user_put = RequestParser()
parser_user_put.add_argument('data', required=True, type=dict)

# парсер для предмета
parser_thing = RequestParser()
parser_thing.add_argument('name', required=True, type=str)
parser_thing.add_argument('weight', default=-1, type=int)
parser_thing.add_argument('height', default=-1, type=int)
parser_thing.add_argument('long', default=-1, type=int)
parser_thing.add_argument('width', default=-1, type=int)
...
parser_thing.add_argument('start_price', required=True, type=int)
parser_thing.add_argument('count', default=1, type=int)
parser_thing.add_argument('user_id', required=True, type=int)

parser_thing_put = RequestParser()
parser_thing_put.add_argument('data', required=True, type=dict)
